...
import 'package:flutter_clean_architecture_2/0_data/data_sources/models/todo_collection_model.dart';
import 'package:flutter_clean_architecture_2/0_data/data_sources/models/todo_entry_model.dart';
import 'package:hive/hive.dart';
import 'package:flutter_clean_architecture_2/0_data/data_sources/interfaces/todo_local_data_source_interface.dart';
import 'package:flutter_clean_architecture_2/0_data/exceptions/exceptions.dart';
...
class HiveLocalDataSource implements ToDoLocalDataSourceInterface {
  ...
  Future<ToDoCollectionModel> getToDoCollection({
    ...
    final collectionBox = await _openCollectionBox();
    final collection = (await collectionBox.get(
      collectionId,
    ))?.cast<String, dynamic>();
    if (collection == null) {
  ...
  Future<ToDoEntryModel> updateToDoEntry({
    ...
    final entry = ToDoEntryModel.fromJson(
      entryList[entryId].cast<String, dynamic>(),
    );
